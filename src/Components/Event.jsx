...
export default function Event() {
  return (
    <div className='grid md:grid-cols-2 grid-cols-1 place-content-center w-[75%] gap-[4rem] m-auto mt-16' >
        <div className="self-center md:justify-self-start justify-self-center w-[90%] h-full 	">
            <img src={Logo} alt='logo'/>
        </div>
        <span className="text-[3rem] md:text-right text-center self-center">
